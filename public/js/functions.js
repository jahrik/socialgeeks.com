function expand(section) {
	$(".expander").each(function (i) {
		if (this.id != section && this.style.display != 'none') {
			$('#' + this.id).slideUp(300);
			$("#expanderSpacer").slideToggle(300); 
		}
	});
	
	var h = $("#" + section).css("height");
	$("#" + section).slideToggle(300); 
	$("#expanderSpacer").css({ height: h}); 
	$("#expanderSpacer").slideToggle(300); 
	scan();
}
...
function formatPhone(number) {
	...
	if (number.length >= 10 && re2.test(number) != true) {
		...
		alert('The phone number you entered appears to be invalid.  Please include the area code.');
		return '';
	}
}
...
// browser hight, width, scroll position functions
